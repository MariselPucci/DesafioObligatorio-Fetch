//====================================== Desafio Obligatorio- Async Fetch - Js==================================================
...
async function main() {
  try {
    ...
    swal.close()
    ARRAYPRODUCTOS = [...data];
    // console.log('ARRPROD',ARRAYPRODUCTOS) 
...
async function finalizarYdisminuirStockDelServer(formulario,modalCarritoCompra){
  ...
  //console.log('143: ',ARRAYPRODUCTOS)
   for (let pedido of modalCarritoCompra.carrito.pedidos){ 
    ...
    const response2 = await fetch(
      `https://633e375c83f50e9ba3ad63d5.mockapi.io/api/v1/productos/${id}`,
      //`https://633e375c83f50e9ba3ad63d5.mockapi.io/api/v1/productos/4000`,
      {method: "PUT",
      ...
      body: JSON.stringify({
        ...
        detalle: detalle,
        id: id
       //cantidad: ARRAYPRODUCTOS[indexOfProducto].cantidad-pedido.cantidad
      })
    } 
     )
